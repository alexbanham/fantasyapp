...
const syracuseRoutes = require('./routes/syracuse');
const nflStandingsRoutes = require('./routes/nflStandings');
// Import services
...
app.use('/api/syracuse', syracuseRoutes);
app.use('/api/nfl-standings', nflStandingsRoutes);
